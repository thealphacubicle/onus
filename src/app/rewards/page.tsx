...
export default function RewardsPage() {
  ...
  const handleRedeem = () => {
    toast.success(
      "Redemption submitted! You'll receive your code within 24 hours."
    );
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-mono text-3xl font-medium text-[#c8f060]">
                  ${MOCK_REWARDS_BALANCE.toFixed(2)}
                </p>
              </div>
            </div>
          </div>
                      ...
                      {isPenalty ? (
                        <>
                          ...
                          <button
                            ...
                            className="w-full rounded-lg bg-[#c8f060] py-2.5 font-medium text-[#0e0e10] transition-opacity hover:opacity-90"
                          >
                            Redeem now
                          </button>
                        </>
                        ...
                        <>
                          ...
                          {category.ctaText && (
                            <button
                              type="button"
                              className="text-xs text-[rgba(240,239,232,0.6)] underline hover:text-[rgba(240,239,232,0.8)]"
                              onClick={(e) => {
                                e.stopPropagation();
